...
This book **does not** assume a lot of HTML, CSS, or JavaScript knowledge. However, this book also does not go into everything you need to know in terms of programming. I will link additional reading sources later on on the specific topics for introducing HTML. 

**If you have questions about anything**, or if something that I wrote about doesn't work, please email `uwigem@uw.edu` to let us know. We can assist you to solve your problem!
